...
using Refaccionaria_los_Mochis.Pages.PDF.Menu;
...
public partial class MenuPage : ContentPage
{
    ...
    public MenuPage()
    {
        ...
        lista.Add(new MenuCLS { idmenu = 1, nombreopcion = "QR Compra", nombreicono = Icono.IconoQR });
        ...
        lista.Add(new MenuCLS { idmenu = 21, nombreopcion = "PDF", nombreicono = Icono.IconoTabla });

        lista.Add(new MenuCLS { idmenu = 22, nombreopcion = "Tomar Foto", nombreicono = Icono.IconoAddCamara });
    ...
    private void lstMenu_ItemTapped(object sender, ItemTappedEventArgs e)
    {
        ...
        {
            App.Current.MainPage = new PrincipalPDF();

        }
        else if (oMenuCLS.idmenu == 22)
        {
            App.Current.MainPage = new BuscarCodigoBarras();
